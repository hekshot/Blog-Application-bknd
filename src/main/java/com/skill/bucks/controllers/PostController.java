...
public class PostController {
	...
	public ApiResponse deletePost(@PathVariable Integer postId) {
		// Call the deletePost method from postService to delete the post
		postService.deletePost(postId);

		// Respond with a 204 (NO_CONTENT) status to indicate successful deletion
	...
	public ResponseEntity<PostDto> updatePost(
			...
			@RequestBody PostDto postDto) {
		// Call the updatePost method from postService to update the post
		...
		if (updatedPost != null) {
			...
			// Handle the case where the update failed (e.g., post not found)
